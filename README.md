...
d) Emissions calculations and visualisations using the scripts "burn_severity.R", "landcover_map.R", "Summarizing land cover and burn severity at 10m intervals_1.R", "emissions_calculations.R" before "Plots and Maps.qmd" can be run to produce the figures.
